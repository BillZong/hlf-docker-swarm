...
# ORG1
ORG1_CA_PATH=$(ls $VOLUMES_DIR/certs/crypto-config/peerOrganizations/org1.example.com/ca/ | grep "_sk")
...
# # replace directories
sed "$FLAG" "s#- .*/certs#- $VOLUMES_DIR/certs#g" $ORDERER0_COMPOSE_PATH
sed "$FLAG" "s#- .*/certs#- $VOLUMES_DIR/certs#g" $PEER_ORG1_COMPOSE_PATH
sed "$FLAG" "s#- .*/certs#- $VOLUMES_DIR/certs#g" $SERVICE_ORG1_COMPOSE_PATH
sed "$FLAG" "s#- .*/chaincode:#- $VOLUMES_DIR/chaincode:#g" $SERVICE_ORG1_COMPOSE_PATH
sed "$FLAG" "s#- .*/fabric-src/#- $VOLUMES_DIR/fabric-src/#g" $SERVICE_ORG1_COMPOSE_PATH
sed "$FLAG" "s#- .*/bin/:#- $VOLUMES_DIR/bin/:#g" $SERVICE_ORG1_COMPOSE_PATH

# ORG2
ORG2_CA_PATH=$(ls $VOLUMES_DIR/certs/crypto-config/peerOrganizations/org2.example.com/ca/ | grep "_sk")
...
# # replace directories
sed "$FLAG" "s#- .*/certs#- $VOLUMES_DIR/certs#g" $ORDERER1_COMPOSE_PATH
sed "$FLAG" "s#- .*/certs#- $VOLUMES_DIR/certs#g" $PEER_ORG2_COMPOSE_PATH
sed "$FLAG" "s#- .*/certs#- $VOLUMES_DIR/certs#g" $SERVICE_ORG2_COMPOSE_PATH
sed "$FLAG" "s#- .*/chaincode:#- $VOLUMES_DIR/chaincode:#g" $SERVICE_ORG2_COMPOSE_PATH
sed "$FLAG" "s#- .*/fabric-src/#- $VOLUMES_DIR/fabric-src/#g" $SERVICE_ORG2_COMPOSE_PATH
sed "$FLAG" "s#- .*/bin/:#- $VOLUMES_DIR/bin/:#g" $SERVICE_ORG2_COMPOSE_PATH

# ORG3
ORG3_CA_PATH=$(ls $VOLUMES_DIR/certs/crypto-config/peerOrganizations/org3.example.com/ca/ | grep "_sk")
...
# # replace directories
sed "$FLAG" "s#- .*/certs#- $VOLUMES_DIR/certs#g" $ORDERER2_COMPOSE_PATH
sed "$FLAG" "s#- .*/certs#- $VOLUMES_DIR/certs#g" $PEER_ORG3_COMPOSE_PATH
sed "$FLAG" "s#- .*/certs#- $VOLUMES_DIR/certs#g" $SERVICE_ORG3_COMPOSE_PATH
sed "$FLAG" "s#- .*/chaincode:#- $VOLUMES_DIR/chaincode:#g" $SERVICE_ORG3_COMPOSE_PATH
sed "$FLAG" "s#- .*/fabric-src/#- $VOLUMES_DIR/fabric-src/#g" $SERVICE_ORG3_COMPOSE_PATH
sed "$FLAG" "s#- .*/bin/:#- $VOLUMES_DIR/bin/:#g" $SERVICE_ORG3_COMPOSE_PATH

# ORG4
ORG4_CA_PATH=$(ls $VOLUMES_DIR/certs/crypto-config/peerOrganizations/org4.example.com/ca/ | grep "_sk")
...
# # replace directories
sed "$FLAG" "s#- .*/certs#- $VOLUMES_DIR/certs#g" $PEER_ORG4_COMPOSE_PATH
sed "$FLAG" "s#- .*/certs#- $VOLUMES_DIR/certs#g" $SERVICE_ORG4_COMPOSE_PATH
sed "$FLAG" "s#- .*/chaincode:#- $VOLUMES_DIR/chaincode:#g" $SERVICE_ORG4_COMPOSE_PATH
sed "$FLAG" "s#- .*/fabric-src/#- $VOLUMES_DIR/fabric-src/#g" $SERVICE_ORG4_COMPOSE_PATH
sed "$FLAG" "s#- .*/bin/:#- $VOLUMES_DIR/bin/:#g" $SERVICE_ORG4_COMPOSE_PATH

# ORG5
ORG5_CA_PATH=$(ls $VOLUMES_DIR/certs/crypto-config/peerOrganizations/org5.example.com/ca/ | grep "_sk")
...
# # replace directories
sed "$FLAG" "s#- .*/certs#- $VOLUMES_DIR/certs#g" $PEER_ORG5_COMPOSE_PATH
sed "$FLAG" "s#- .*/certs#- $VOLUMES_DIR/certs#g" $SERVICE_ORG5_COMPOSE_PATH
sed "$FLAG" "s#- .*/chaincode:#- $VOLUMES_DIR/chaincode:#g" $SERVICE_ORG5_COMPOSE_PATH
sed "$FLAG" "s#- .*/fabric-src/#- $VOLUMES_DIR/fabric-src/#g" $SERVICE_ORG5_COMPOSE_PATH
sed "$FLAG" "s#- .*/bin/:#- $VOLUMES_DIR/bin/:#g" $SERVICE_ORG5_COMPOSE_PATH

# ORG6
ORG6_CA_PATH=$(ls $VOLUMES_DIR/certs/crypto-config/peerOrganizations/org6.example.com/ca/ | grep "_sk")
...
# # replace directories
sed "$FLAG" "s#- .*/certs#- $VOLUMES_DIR/certs#g" $PEER_ORG6_COMPOSE_PATH
sed "$FLAG" "s#- .*/certs#- $VOLUMES_DIR/certs#g" $SERVICE_ORG6_COMPOSE_PATH
sed "$FLAG" "s#- .*/chaincode:#- $VOLUMES_DIR/chaincode:#g" $SERVICE_ORG6_COMPOSE_PATH
sed "$FLAG" "s#- .*/fabric-src/#- $VOLUMES_DIR/fabric-src/#g" $SERVICE_ORG6_COMPOSE_PATH
sed "$FLAG" "s#- .*/bin/:#- $VOLUMES_DIR/bin/:#g" $SERVICE_ORG6_COMPOSE_PATH

# ORG7
ORG7_CA_PATH=$(ls $VOLUMES_DIR/certs/crypto-config/peerOrganizations/org7.example.com/ca/ | grep "_sk")
...
# # replace directories
sed "$FLAG" "s#- .*/certs#- $VOLUMES_DIR/certs#g" $PEER_ORG7_COMPOSE_PATH
sed "$FLAG" "s#- .*/certs#- $VOLUMES_DIR/certs#g" $SERVICE_ORG7_COMPOSE_PATH
sed "$FLAG" "s#- .*/chaincode:#- $VOLUMES_DIR/chaincode:#g" $SERVICE_ORG7_COMPOSE_PATH
